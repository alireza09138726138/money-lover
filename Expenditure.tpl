...
<div class="container">
        <div class="row">
                ...
                <center>			<h3 style='color:white;font-family: "Times New Roman", Times, serif;'>( EXPENDITURE OF BETWEEN TIMES WHIT PRODUCT NAME ) </h3> </center>  
...
<table>
 ...
 {foreach from=$resulttt item=row}
  <tr>
                 ...
                 <th style='text-align:center;color:grey'><h2 class='h5'><span ><b><i>{$row.name}</i></b></span></h2>
