...
<h3 align="center" style='color:black;font-family: "Times New Roman", Times, serif;'>Money lover</h3>
                 <h3 align="center" style='color:gray;font-family: "Times New Roman", Times, serif;'>( EXPENDITURE OF YEAR )</h3>
...
<input class="btn2" type="text" value=""  name="YEAR" placeholder="Enter YEAR" class="form-control" id='button' onclick="showDiv('toggle')" style=' background-color: #ffd984;color:rgb(0, 0, 0); font-weight: bold;font-style: italic;'>
</thead>
    ...
    elseif (isset($_POST['submite']))
 {
		  ...
		  $result=0;
            $YEAR= mysqli_real_escape_string($con,$_POST['YEAR']);
			 ...
			 $result=mysqli_query($con,"select * from produ where Price IS NOT NULL AND year='".$YEAR."'") or die(mysqli_error());
...
$counter++;}
	...
	$result = mysqli_query($con,"SELECT sum(Price) FROM produ where year='".$YEAR."'") or die(mysqli_error());
