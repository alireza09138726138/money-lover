    ...
    elseif (isset($_POST['submite']))
 {
		  ...
		  $result=0;
			...
			$MONTH= mysqli_real_escape_string($conn,$_POST['MONTH']);
			 $result=mysqli_query($conn,"select * from produ where Price IS NOT NULL AND year='".$YEAR."' AND month='".$MONTH."'") or die(mysqli_error());
...
$counter++;}
	...
	$result = mysqli_query($conn,"SELECT sum(Price) FROM produ where year='".$YEAR."' AND month='".$MONTH."'") or die(mysqli_error());
