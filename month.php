...
<h3 align="center" style='color:black;font-family: "Times New Roman", Times, serif;'>Money lover</h3>
                 <h3 align="center" style='color:gray;font-family: "Times New Roman", Times, serif;'>( EXPENDITURE OF YEAR,MONTH )</h3>
    ...
    elseif (isset($_POST['submite']))
 {
		  ...
		  $result=0;
			...
			$MONTH= mysqli_real_escape_string($con,$_POST['MONTH']);
			 $result=mysqli_query($con,"select * from produ where Price IS NOT NULL AND year='".$YEAR."' AND month='".$MONTH."'") or die(mysqli_error());
...
$counter++;}
	...
	$result = mysqli_query($con,"SELECT sum(Price) FROM produ where year='".$YEAR."' AND month='".$MONTH."'") or die(mysqli_error());
