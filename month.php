...
$rows =null;
    ...
    $result = mysqli_query($conn, "select * from produ where Price IS NOT NULL AND year='".$YEAR."' AND month='".$MONTH."'") or die(mysqli ($result));
	$rows = mysqli_fetch_all ($result, MYSQLI_ASSOC);
	
	$resultt = mysqli_query($conn,"SELECT sum(Price) FROM produ where year='".$YEAR."' AND month='".$MONTH."'") or die(mysqli_error());
