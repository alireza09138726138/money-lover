...
<nav class="w3-sidebar w3-black w3-animate-top w3-xxlarge nav"  id="mySidebar">
  <a href="javascript:void(0)" onclick="w3_close()" class="w3-button w3-black w3-xxlarge w3-padding w3-display-topleft" >
	...
	<a href="times.php" class="w3-bar-item w3-button w3-text-grey w3-hover-black"><h3>Expenditure of between times</h3></a>
...
<span class="w3-button w3-xxlarge  w3-left" id='colorwhite' onclick="w3_open()"><i class="fa fa-bars"></i></span> 
